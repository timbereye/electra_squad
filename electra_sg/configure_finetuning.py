...
class FinetuningConfig(object):
  ...
  def __init__(self, model_name, data_dir, output_dir, features_dir, **kwargs):
    # general
    ...
    pretrained_model_dir = os.path.join(data_dir, "pretrained_models", model_name)
    ...
    self.qa_nb_file = os.path.join(qa_topdir, "{:}_nbest.json").format
